...
class Connection extends Component
{
    ...
    public function open()
    {
        if ($this->mongoClient === null) {
            ...
            try {
                ...
                //$tp = time().'xxx'.json_encode($this->mongoClient->getConnections(),JSON_UNESCAPED_UNICODE);
                //file_put_contents('F:\t.txt', $tp,FILE_APPEND);
    ...
    public function getListCollections(){
    	return $this->getDatabase()->listCollection();
    }
}
