...
class LinkPager extends Widget
{
    ...
    protected function renderPageButtons()
    {
        ...
        $buttons[] = '<li id = "pgtotal" class="pgtotal">每页'.$this->pagination->pageSize.'条，当前第'.($currentPage+1).'页， 共：'. $this->pagination->totalCount.'条，'.$pageCount.'页</li>';
      
        return '<div class="s_lifepage">'. Html::tag('ul', implode("\n", $buttons), $this->options).'</div>';
    }
