...
class Command extends Component
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            Yii::endProfile($token, __METHOD__);
            //$this->db->init();
            //file_put_contents("D:xampp/htdocs/yii2-base-framework/console/runtime/logs/test".__LINE__.".txt",$e->getMessage(),FILE_APPEND);
   ...
   protected function pdoPing(){
    	try{
    		if($this->db->pdo == null){
    			//file_put_contents("D:xampp/htdocs/yii2-base-framework/console/runtime/logs/test".__LINE__.".txt",'pdoPing pdo null',FILE_APPEND);
    			$this->db->close();
    			$this->db->open();
    			return true;
    		}
    		
    		$this->db->pdo->getAttribute(\PDO::ATTR_SERVER_INFO);
